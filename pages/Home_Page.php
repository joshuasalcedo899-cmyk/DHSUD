    ...
    <div class="admin-home-header">
        ...
        <div id="addModalOverlay" class="edit-modal-overlay" style="display:none;">
            <div class="edit-modal" id="addModal">
                ...
                <h2 style="text-align:center;color:#1a237e;font-size:1.15em;font-weight:bold;margin-bottom:30px;letter-spacing:1px;">ADD NEW RECORD</h2>
                <form id="addForm" autocomplete="off">
                    ...
                    <div class="modal-actions">
                        ...
                        <button type="button" class="modal-btn cancel" style="background:#AA4444; color:#fff;" onclick="clearAddForm()">Clear Form</button>
                    </div>
                </form>
            </div>
        </div>
