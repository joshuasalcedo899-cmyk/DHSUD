...
INSERT INTO `archive` (`id`, `original_mail_id`, `Notice/Order Code`, `Date released to AFD`, `Parcel No.`, `Recipient Details`, `Parcel Details`, `Sender Details`, `File Name (PDF)`, `Tracking No.`, `Status`, `Transmittal ID`, `Transmittal Remarks/Received By`, `Date`, `Evaluator`, `deleted_at`) VALUES
...
INSERT INTO `mailtracking` (`id`, `Notice/Order Code`, `Date released to AFD`, `Parcel No.`, `Recipient Details`, `Parcel Details`, `Sender Details`, `File Name (PDF)`, `Tracking No.`, `Status`, `Transmittal ID`, `Transmittal Remarks/Received By`, `Date`, `Evaluator`) VALUES
